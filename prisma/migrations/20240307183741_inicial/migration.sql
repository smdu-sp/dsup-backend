...
CREATE TABLE `servicos_materiais` (
    ...
    UNIQUE INDEX `servicos_materiais_servico_id_material_id_key`(`servico_id`, `material_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `servicos_materiais` ADD CONSTRAINT `servicos_materiais_material_id_fkey` FOREIGN KEY (`material_id`) REFERENCES `materiais`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
